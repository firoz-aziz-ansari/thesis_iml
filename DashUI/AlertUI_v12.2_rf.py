...
# pickle.dump(model, open("Data/model_log.p", "wb"))

model = pickle.load(open("Data/model_log.p", "rb"))
...
#
# pickle.dump(shap_train, open("Data/shap_train_log.p", "wb"))
# pickle.dump(shap_test, open("Data/shap_test_log.p", "wb"))

shap_train = pickle.load(open("Data/shap_train_log.p", "rb"))
shap_test = pickle.load(open("Data/shap_test_log.p", "rb"))

# iso_shap_plot_object = Isomap(n_components=2).fit(shap_train)
# pickle.dump(iso_shap_plot_object, open("Data/isomap_log.p", "wb"))

iso_shap_plot_object = pickle.load(open("Data/isomap_log.p", "rb"))

# neighbors = NearestNeighbors(n_neighbors=20, metric='euclidean')
# neighbors.fit(shap_train)
# pickle.dump(neighbors, open("Data/neighbor_log.p", "wb"))

neighbors = pickle.load(open("Data/neighbor_log.p", "rb"))

all_alerts = [970, 28798, 29110, 20803, 9809, 6338, 13872, 4570, 11330, 86]
